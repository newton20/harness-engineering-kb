...
type: code-research
status: compiled
compiled_to: [wiki/agent-memory-and-context-management.md, wiki/long-running-agent-harnesses.md, wiki/auto-mode-and-safety.md, wiki/tool-design-patterns.md]
