---
title: "X Article by garrytan"
source: https://x.com/garrytan/status/2042925773300908103?s=20
handle: garrytan
date: 2026-04-13
fetched: 2026-04-13
type: article
...
### Full Content of the X Post by @garrytan (ID: 2042925773300908103)
...
**Timestamp:** Sat, 11 Apr 2026 11:20:34 GMT  
**Engagement:** Likes=2663, Reposts=246, Quotes=90, Replies=92, Bookmarks=7972, Views=805023  
...
That gap — "says" versus "actually building" — requires reading the GitHub commit history, the application, and the advisor transcript, and holding all three in mind at once. No embedding similarity search finds this. No keyword filter finds it. The model has to read the full profile and make a judgment.  
...
The same pattern transfers everywhere: retrieve, read, diarize, count, synthesize. Then: survey, investigate, diarize, rewrite the skill. It's a universal loop.  
...
*(Note: This post appears to be a long-form article shared directly on X. The tool fetch also included related replies and context, but the above is the complete, verbatim content of the specified post ID. No media was attached to this main post.)*