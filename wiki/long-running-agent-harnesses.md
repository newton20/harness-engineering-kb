...
- [raw/code-research-claude-code.md](../raw/code-research-claude-code.md) -- Code research, Apr 2026 (re-run). 6-layer compaction cascade, forked agent pattern for background work, session memory as zero-cost compaction backend, post-compact file re-injection, circuit breaker on autocompact failures.
...
- [raw/code-research-openclaw-openclaw.md](../raw/code-research-openclaw-openclaw.md) -- Code research, Apr 2026 (re-run). Compaction as distributed transaction with 7-step protocol and 25 checkpoints, identifier preservation in summarization, post-compaction AGENTS.md re-injection with date resolution.
